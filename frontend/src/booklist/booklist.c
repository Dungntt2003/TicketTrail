...
//thêm typedef struct ConfirmParams 21-25
typedef struct {         
    Ticket *tickets;
    int *ticket_count;
    int index;
...
//thêm hàm show_confirmation_dialog,on_cancel_confirm,on_change_confirm từ 35-78
...
// thêm on_button_press (thay đổi hoàn toàn hàm on_button_press)
